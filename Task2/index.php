...
<body>
    ...
    <div class="container mt-30">
        <h2 align="center">Insert Items:-</h2>
            ...
            <form name="add_item" id="add_item">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dynamic_field">
                        <tr>
                            <td>
                                <input type="text" name="itemName[]" id="itemName" placeholder="Add Items:-"
                ...
                <table class="table table-bordered" id="dynamic_item_list">
                    ...
                    {   $x++;
                        echo "<tr>
                                <td>$x</td>
                                <td>$row[itemName]</td>
                                <td><a class='btn btn-primary btn-sm' href='edit.php?id=$row[id]'><i class='fa fa-pencil' aria-hidden='true'></i></a></td>
